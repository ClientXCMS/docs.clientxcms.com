...
title: "Nouvelle Landing Page & Quote Manager"
authors: [martindev]
...
## Nouvelle Landing Page ClientXCMS

Nous avons entièrement repensé la page d'accueil de ClientXCMS pour la rendre plus moderne, plus claire et plus représentative de l'évolution de notre solution.

Cette nouvelle interface met en avant les fonctionnalités clés de notre CMS de manière plus intuitive et vous permet de découvrir plus facilement l'étendue de nos services.

## Nouvel Addon : Quote Manager
...
![Aperçu Client Quote Manager](/img/next_gen/extensions/addons/quote_manager/preview_customer.png)

Découvrez et procurez-vous le Quote Manager sur notre marketplace : [https://clientxcms.com/resources/quote-manager](https://clientxcms.com/resources/quote-manager)

## Ressources et Documentation Entièrement Traduites

L'accessibilité est une de nos priorités. C'est pourquoi nous sommes fiers de vous annoncer que **toutes nos ressources sont désormais totalement traduites**, y compris la documentation officielle.

![Ressources traduites](/img/blog/new-landing-page-quote_manager/translated_items.png)

Que vous soyez francophone, anglophone ou autre, vous pourrez désormais naviguer et configurer votre site ClientXCMS dans votre langue maternelle avec une traduction de qualité.
...
![Nouveaux Avantages Licences](/img/blog/new-landing-page-quote_manager/pricing.png)
