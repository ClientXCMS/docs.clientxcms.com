...
:::info
Cet addon nécessite que le module Proxmox soit activé sur votre CLIENTXCMS. [cliquez ici pour l'activer](../modules/Proxmox.md)
:::

## Configuration de l'addon
Pour configurer l'addon, rendez-vous dans votre fichier d'environnement `.env` et ajoutez les variables suivantes :
...
:::info
Cet addon a été développé pour des utilisations spécifiques. N'hésitez pas à nous contacter pour toute demande de fonctionnalité ou d'amélioration.
:::
