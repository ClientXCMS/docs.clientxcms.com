...
Résultat : la card apparaît sur la page des paramètres, affichant le titre et la description résolus, avec l'item listé en dessous sous forme d'icône plus son propre titre et description, pointant vers l'action du contrôleur.
