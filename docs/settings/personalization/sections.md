...
**Section texte** | (contenu éditorial)<br />
...
**Section héros** | (bannière principale)<br />
...
**Section témoignages** | (preuves sociales)<br />
...
**Section FAQ** | (questions-réponses)<br />
...
**Section produits** | (showcase offres)<br />
...
**Section CTA** | (appels à l'action)<br />
...
**Couleur de fond** | (arrière-plan)<br />
...
**Image de fond** | (visuel d'ambiance)<br />
...
**Visibilité** | (affichage conditionnel)<br />
...
**Preuve sociale** | (effet moutonnier)<br />
...
**Urgence et rareté** | (scarcity marketing)<br />
...
**Bénéfices clients** | (value proposition)<br />
