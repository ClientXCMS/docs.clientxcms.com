...
![Image: SocialAuth+ Onglet](/img/next_gen/Modules/SocialAuth/SA+_extension.png)
...
![Image: SocialAuth+ Config](/img/next_gen/Modules/SocialAuth/SA+_page.png)
...
![Image : Exemple page configuration OAuth](/img/next_gen/Modules/SocialAuth/SA+_exemple_config.png)
...
![Image: Google Config - Bouton "Sélectionner le projet"](/img/next_gen/Modules/SocialAuth/SA+_Google1.png)
...
![Image: Google Config - Raccourci accès rapide "API et services"](/img/next_gen/Modules/SocialAuth/SA+_Google2.png)

**5.** Accédez à la section "**Ecran de consentement OAuth**" dans la colonne de gauche.

![Image: Google Config - Section "Ecran de consentement OAuth"](/img/next_gen/Modules/SocialAuth/SA+_Google3.png)

**6.** Sélectionnez l'option "**Externes**", cliquez ensuite sur le bouton "**Créer**".
![Image: Google Config - Bouton "Externes" consentement](/img/next_gen/Modules/SocialAuth/SA+_Google4.png)
...
![Image : Google Config - Niveaux d'accès consentement](/img/next_gen/Modules/SocialAuth/SA+_Google5.png)


Sélectionnez tous les champs et cliquez sur le bouton bleu "**Mettre à jour**" en dessous.
![Image : Google Config - Champs de niveaux d'accès consentement](/img/next_gen/Modules/SocialAuth/SA+_Google6.png)
![](/img/next_gen/Modules/SocialAuth/SA+_Google7.png)
...
![Image : Google Config - "Domaines autorisés"](/img/next_gen/Modules/SocialAuth/SA+_Google8.png)

**9.** Accédez à la section "**Identifiants**" dans la colonne de gauche.

![Image: Google Config - Section "Identifiants"](/img/next_gen/Modules/SocialAuth/SA+_Google9.png)

**10.** Cliquez sur "**Créer des identifiants**" et choisissez "ID client OAuth".
![Image: Google Config - Bouton "ID client OAuth"](/img/next_gen/Modules/SocialAuth/SA+_Google10.png)

**11.** Sélectionnez le type d'application approprié (ici : **Application Web**) et définissez le nom de votre application
![Image : Google Config - Type d'applications](/img/next_gen/Modules/SocialAuth/SA+_Google11.png)
...
![Image : Google Config - Redirect URI Google](/img/next_gen/Modules/SocialAuth/SA+_Google12.png)

**13.** Une fois que vous avez créé l'application OAuth, vous obtiendrez les clés d'authentification OAuth2 nécessaires.
![Google Config - API Send](/img/next_gen/Modules/SocialAuth/SA+_Google13.png)
...
![Image : Discord Config - Menu Navigation "OAuth2"](/img/next_gen/Modules/SocialAuth/SA+_Discord3.png)
![Image : Discord Config - Interface OAuth2"](/img/next_gen/Modules/SocialAuth/SA+_Discord4.png)
...
![Image : Discord Config - Révéler le Client Secret"](/img/next_gen/Modules/SocialAuth/SA+_Discord5.png)
...
![Image : Discord Config - Redirect URI Discord](/img/next_gen/Modules/SocialAuth/SA+_Discord6.png)

**7.** Cliquez sur le bouton "**Save Changes**" en bas pour sauvegarder les changements. Copiez les clés "Client ID" et "Client Secret". 
![Discord Config - API Send](/img/next_gen/Modules/SocialAuth/SA+_Discord7.png)
...
![Image : GitHub Config - "Developer Settings"](/img/next_gen/Modules/SocialAuth/SA+_Github1.png)

**4.** Cliquez sur le bouton "[**New GitHub App**](https://github.com/settings/apps/new)" pour enregistrer une nouvelle application.
![Image : GitHub Config - "New GitHub App"](/img/next_gen/Modules/SocialAuth/SA+_Github2.png)

**5.** Remplissez les informations de base de votre application.
![Image : GitHub Config - Informations de base](/img/next_gen/Modules/SocialAuth/SA+_Github3.png)
...
![Image : GitHub Config - Redirect URI GitHub](/img/next_gen/Modules/SocialAuth/SA+_Github4.png)
...
![Image : GitHub Config - Désactiver Webhook et autres paramètres](/img/next_gen/Modules/SocialAuth/SA+_Github5.png)
![Image : GitHub Config - Permissions](/img/next_gen/Modules/SocialAuth/SA+_Github6.png)
...
![Image : GitHub Config - Qui peut installer cette application](/img/next_gen/Modules/SocialAuth/SA+_Github7.png)
...
![Image : GitHub Config - Page de gestion de l'application](/img/next_gen/Modules/SocialAuth/SA+_Github8.png)
...
![Image : GitHub Config - Section "Client secrets"](/img/next_gen/Modules/SocialAuth/SA+_Github9.png)
...
![Image : GitHub Config - Section "About" Client ID](/img/next_gen/Modules/SocialAuth/SA+_Github10.png)
...
![Image : GitHub Config - API Send](/img/next_gen/Modules/SocialAuth/SA+_Github11.png)
...
![Image : Facebook Config - Bouton "Créer une app"](/img/next_gen/Modules/SocialAuth/SA+_Facebook1.png)
...
![Image : Facebook Config - Option "Autoriser les utilisateurs à se connecter avec leur compte Facebook"](/img/next_gen/Modules/SocialAuth/SA+_Facebook2.png)
...
![Image : Facebook Config - Informations relatives à l'application](/img/next_gen/Modules/SocialAuth/SA+_Facebook3.png)

**5.** Une fois l'application créée, vous serez automatiquement redirigé vers le panneau de gestion de l'application.
![Image : Facebook Config - Panneau de gestion de l'application](/img/next_gen/Modules/SocialAuth/SA+_Facebook4.png)
...
![Image : Facebook Config - Page "Produits"](/img/next_gen/Modules/SocialAuth/SA+_Facebook5.png)
Dans le petit menu déroulant du bouton "**Configurer**", sélectionnez "**Paramètres**".
![Image : Facebook Config - Menu déroulant Paramètres Facebook Login "](/img/next_gen/Modules/SocialAuth/SA+_Facebook6.png)
...
![Image : Facebook Config - Redirect URI Facebook](/img/next_gen/Modules/SocialAuth/SA+_Facebook7.png)
...
![Image : Facebook Config - API Send](/img/next_gen/Modules/SocialAuth/SA+_Facebook8.png)
...
![Image : Facebook Config - Publier l'application](/img/next_gen/Modules/SocialAuth/SA+_Facebook9.png)
...
![Image : ModSecurity Apache - "Detection only"](/img/next_gen/Modules/SocialAuth/SA+_error403.png)
