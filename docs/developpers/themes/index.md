...
You can enable or disable a theme by clicking the `Enable` or `Disable` button corresponding to the theme. Each theme is shown as a card with a preview thumbnail, its status, name, and description.
