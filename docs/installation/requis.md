...
:::
### PHP
ClientXCMS nécessite PHP 8.3 ou supérieur. Vous pouvez vérifier la version de PHP installée sur votre serveur en utilisant la commande suivante :
```bash
php -v
```
:::warning
ClientXCMS ne supporte pas les versions de PHP inférieures à 8.3.
:::
#### Extensions PHP
